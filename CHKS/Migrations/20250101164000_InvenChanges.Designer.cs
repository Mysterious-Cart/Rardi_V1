...
namespace CHKS.Migrations
{
    ...
    [Migration("20250101164000_InvenChanges")]
    partial class InvenChanges
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("InventoryTags", b =>
                {
                    ...
                    b.ToTable("InventoryTags", t =>
                        {
                            t.HasTrigger("InventoryTags_Trigger");
                        });
                });
            ...
            modelBuilder.Entity("InventoryTags", b =>
                {
                    b.HasOne("CHKS.Models.mydb.Inventory", null)
                        .WithMany()
                        .HasForeignKey("ProductId")
                        .IsRequired();

                    b.HasOne("CHKS.Models.mydb.Tags", null)
                        .WithMany()
