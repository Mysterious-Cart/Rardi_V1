...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CHKS.Models.mydb.Cashback", b =>
                {
                    b.Property<string>("Key")
                        .HasColumnType("varchar(255)");
                    ...
                    b.ToTable("cashback", t =>
                        {
                            t.HasTrigger("cashback_Trigger");
                        });
                });

            modelBuilder.Entity("CHKS.Models.mydb.Changesrecord", b =>
                {
            ...
            modelBuilder.Entity("CHKS.Models.mydb.InventoryCaroption", b =>
                {
                    b.Property<string>("Key")
                        .HasColumnType("varchar(255)");
                    ...
                    b.ToTable("inventory_caroption", t =>
                        {
                            t.HasTrigger("inventory_caroption_Trigger");
                        });
                });

            modelBuilder.Entity("CHKS.Models.mydb.InventoryOption", b =>
                {
                    b.Property<string>("Key")
                        .HasColumnType("varchar(255)");
                    ...
                    b.ToTable("inventory_option", t =>
                        {
                            t.HasTrigger("inventory_option_Trigger");
                        });
                });

            modelBuilder.Entity("CHKS.Models.mydb.InventoryProductgroup", b =>
                {
                    b.Property<string>("Key")
                        .HasColumnType("varchar(255)");
                    ...
                    b.ToTable("inventory_productgroup", t =>
                        {
                            t.HasTrigger("inventory_productgroup_Trigger");
                        });
                });
