...
namespace CHKS.Pages
{
    public partial class ApplicationUsers
    {
        ...
        protected IEnumerable<CHKS.Models.ApplicationUser> users;
        protected RadzenDataGrid<CHKS.Models.ApplicationUser> grid0;
        ...
        protected async Task RowSelect(CHKS.Models.ApplicationUser user)
        {
        ...
        protected async Task DeleteClick(CHKS.Models.ApplicationUser user)
        {
            try
            {
