...
namespace CHKS
{
    public partial class fordevService
    {
        ...
        partial void OnGetDailyexpenseByNote(ref IQueryable<CHKS.Models.fordev.Dailyexpense> items);


        public async Task<CHKS.Models.fordev.Dailyexpense> GetDailyexpenseByNote(string note)
        {
        ...
        public async Task<CHKS.Models.fordev.Dailyexpense> UpdateDailyexpense(string note, CHKS.Models.fordev.Dailyexpense dailyexpense)
        {
        ...
        public async Task<CHKS.Models.fordev.Dailyexpense> DeleteDailyexpense(string note)
        {
        ...
        {
            navigationManager.NavigateTo(query != null ? query.ToUrl($"export/fordev/expensehistoryconnectors/excel(fileName='{(!string.IsNullOrEmpty(fileName) ? UrlEncoder.Default.Encode(fileName) : "Export")}')") : $"export/fordev/expensehistoryconnectors/excel(fileName='{(!string.IsNullOrEmpty(fileName) ? UrlEncoder.Default.Encode(fileName) : "Export")}')", true);
        }

        public async Task ExportExpensehistoryconnectorsToCSV(Query query = null, string fileName = null)
        {
            navigationManager.NavigateTo(query != null ? query.ToUrl($"export/fordev/expensehistoryconnectors/csv(fileName='{(!string.IsNullOrEmpty(fileName) ? UrlEncoder.Default.Encode(fileName) : "Export")}')") : $"export/fordev/expensehistoryconnectors/csv(fileName='{(!string.IsNullOrEmpty(fileName) ? UrlEncoder.Default.Encode(fileName) : "Export")}')", true);
        }

        partial void OnExpensehistoryconnectorsRead(ref IQueryable<CHKS.Models.fordev.Expensehistoryconnector> items);

        public async Task<IQueryable<CHKS.Models.fordev.Expensehistoryconnector>> GetExpensehistoryconnectors(Query query = null)
        {
        ...
        partial void OnExpensehistoryconnectorGet(CHKS.Models.fordev.Expensehistoryconnector item);
        partial void OnGetExpensehistoryconnectorByDate(ref IQueryable<CHKS.Models.fordev.Expensehistoryconnector> items);


        public async Task<CHKS.Models.fordev.Expensehistoryconnector> GetExpensehistoryconnectorByDate(string date)
        {
        ...
        partial void OnExpensehistoryconnectorCreated(CHKS.Models.fordev.Expensehistoryconnector item);
        partial void OnAfterExpensehistoryconnectorCreated(CHKS.Models.fordev.Expensehistoryconnector item);

        public async Task<CHKS.Models.fordev.Expensehistoryconnector> CreateExpensehistoryconnector(CHKS.Models.fordev.Expensehistoryconnector expensehistoryconnector)
        {
        ...
        public async Task<CHKS.Models.fordev.Expensehistoryconnector> CancelExpensehistoryconnectorChanges(CHKS.Models.fordev.Expensehistoryconnector item)
        {
            var entityToCancel = Context.Entry(item);
            if (entityToCancel.State == EntityState.Modified)
            {
        ...
        partial void OnExpensehistoryconnectorUpdated(CHKS.Models.fordev.Expensehistoryconnector item);
        partial void OnAfterExpensehistoryconnectorUpdated(CHKS.Models.fordev.Expensehistoryconnector item);

        public async Task<CHKS.Models.fordev.Expensehistoryconnector> UpdateExpensehistoryconnector(string date, CHKS.Models.fordev.Expensehistoryconnector expensehistoryconnector)
        {
        ...
        partial void OnExpensehistoryconnectorDeleted(CHKS.Models.fordev.Expensehistoryconnector item);
        partial void OnAfterExpensehistoryconnectorDeleted(CHKS.Models.fordev.Expensehistoryconnector item);

        public async Task<CHKS.Models.fordev.Expensehistoryconnector> DeleteExpensehistoryconnector(string date)
        {
